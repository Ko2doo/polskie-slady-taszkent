<script>
  /**
   * First step: generate map style.json with command:
   * node scripts/generateMaplibreBaseStyle.mjs
   * Second step: rename this file Map.svelte, and move src/views
   *
   * Documentation:
   *
  ...
  const GEOJSON = "/map/tashkent_boundaries.geojson";
